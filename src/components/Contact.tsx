...
export default function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Handle form submission - can integrate with emailjs or similar
      ...
      <div className="container mx-auto px-6" ref={ref}>
        ...
        >
          ...
          <p className="text-gray-400 mt-4 max-w-2xl mx-auto">
            I&apos;m interested in freelance opportunities and ambitious projects.
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          >
            ...
            <div className="pt-6">
              ...
              >
                <span className="text-gray-400">Follow me on</span>
                <motion.span 
              ...
              <div className="flex gap-4">
                ...
                >
                  {/* Animated gradient border on hover */}
                  <span className="absolute inset-0 rounded-xl bg-gradient-to-r from-primary to-secondary opacity-0 group-hover:opacity-100 transition-opacity" />
                  <span className="absolute inset-[2px] rounded-xl bg-dark-lighter group-hover:bg-dark transition-colors" />
                  {/* Shine effect */}
                ...
                >
                  {/* Animated gradient border on hover */}
                  <span className="absolute inset-0 rounded-xl bg-gradient-to-r from-secondary to-primary opacity-0 group-hover:opacity-100 transition-opacity" />
                  <span className="absolute inset-[2px] rounded-xl bg-dark-lighter group-hover:bg-dark transition-colors" />
                  {/* Shine effect */}
                  <span className="absolute inset-0 -translate-x-full group-hover:translate-x-full transition-transform duration-500 bg-gradient-to-r from-transparent via-white/20 to-transparent" />
                  <span className="absolute inset-0 flex items-center justify-center z-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid sm:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 rounded-xl glass bg-transparent text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-primary transition-all"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={5}
                  className="w-full px-4 py-3 rounded-xl glass bg-transparent text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-primary transition-all resize-none"
              ...
              <motion.button
                type="submit"
                className="group relative w-full py-4 rounded-xl bg-gradient-to-r from-primary to-secondary text-white font-semibold overflow-hidden"
